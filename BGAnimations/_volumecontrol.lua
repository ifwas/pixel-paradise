--i was actually getting tired of controlling the volume with the debug menu
...
local bgThingX = SCREEN_LEFT - 155
...
t[#t+1] = Def.ActorFrame {
    ...
    Def.Quad {
        ...
        volumeChangedMessageCommand = function(self)
            self:stoptweening()
            self:zoomto(175 * curGameVolume, 2):finishtweening()
