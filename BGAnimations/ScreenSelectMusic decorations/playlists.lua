...
t[#t + 1] = Def.Sprite {
	InitCommand = function(self)
		self:xy(frameX + 5, frameY + 20)
		self:Load(THEME:GetPathG("","spr/tab/playlistBox")):SetTextureFiltering(false)
		self:zoom(0.41):halign(0):valign(0)
...
t[#t + 1] = Def.Sprite {
	InitCommand = function(self)
		...
		self:Load(THEME:GetPathG("","spr/tab/playlistHeader")):SetTextureFiltering(false)
		self:zoom(0.41):halign(0):valign(0)
		self:diffuse(ColorMultiplier(getMainColor("highlight"),1.5))
	end
}
t[#t + 1] = LoadFont("Common Normal") .. {
	InitCommand = function(self)
		self:xy(frameX + 20, frameY + 2):zoom(0.65):halign(0)
...
r[#r + 1] = Def.ActorFrame {
	InitCommand = function(self)
		self:xy(frameX - capWideScale(310, 300), frameY + rankingY + 250)
	end,
	UIElements.TextToolTip(1, 1, "Common Large") .. {
		InitCommand = function(self)
	...
	UIElements.TextToolTip(1, 1, "Common Large") .. {
		...
		DisplayAllPlaylistsMessageCommand = function(self)
			...
			self:x(capWideScale(200,30))
		end,
		DisplaySinglePlaylistMessageCommand = function(self)
			self.state = "Upload"
			self:queuecommand("MaintainState")
			self:settext(translated_info["UploadOnline"])
			self:xy(capWideScale(230,30), 10)
		end,
		MouseDownCommand = function(self, params)
	...
	UIElements.TextToolTip(1, 1, "Common Large") .. {
		InitCommand = function(self)
			self:halign(0):zoom(0.25):diffuse(getMainColor("positive"))
			self:xy(capWideScale(290,150), 10)
...
local function PlaylistSelectLabel(i)
	local t = Def.ActorFrame {
		InitCommand = function(self)
			self:xy(rankingX + offsetX + capWideScale(0,40), rankingY + offsetY + 20 + (i - 1) * PlaylistYspacing)
			self:visible(true)
		end,
		DisplaySinglePlaylistMessageCommand = function(self)
			self:visible(false)
...
r[#r + 1] = Def.ActorFrame {
	InitCommand = function(self)
		self:xy(frameX + capWideScale(10,-80), frameY + rankingY + 250)
	end,
	UIElements.TextToolTip(1, 1, "Common Large") .. {
		InitCommand = function(self)
