...
local skillestxpleasebeconsistentmina = frameX - 50
local tagXPos = skillestxpleasebeconsistentmina - 130
local skillsetPrevalentY = frameY - 60
local distanceSkillsetY = 30
local tagPrevalentY = skillsetPrevalentY + 30
...
local t = Def.ActorFrame {
	...
	OffCommand = function(self)
		self:bouncebegin(0.2):xy(800, 0):diffusealpha(0)
		toggleCalcInfo(false)
	...
	Def.Sprite {
		InitCommand = function(self)
			self:xy(frameX, frameY - 146):zoom(0.45):halign(0):valign(0)
			self:Load(THEME:GetPathG("","spr/wheel/NonBPMChangerRadarbox")):SetTextureFiltering(false)
			self:diffuse(getMainColor("positive"))
		end
	},
	Def.Sprite {
		InitCommand = function(self)
			self:xy(frameX - 5, frameY - 20):zoom(0.5):halign(0):valign(0):halign(0)
			self:Load(THEME:GetPathG("","spr/wheel/WifePersonalRecordBox")):SetTextureFiltering(false)
			self:diffuse(getMainColor("positive"))
		end
	},
	Def.Sprite {
		InitCommand = function(self)
			self:xy(frameX, frameY - 200):zoom(0.45):halign(0):valign(0)
			self:Load(THEME:GetPathG("","spr/wheel/MsdBox")):SetTextureFiltering(false)
			self:diffuse(getMainColor("positive"))
		end
	},
}
...
t[#t + 1] = Def.ActorFrame {
	...
	LoadFont("Common Large") .. {
		Name = "MSD",
		InitCommand = function(self)
			self:xy(frameX + 100, frameY - 174):halign(1):zoom(0.65):maxwidth(110 / 0.6)
		end,
		MintyFreshCommand = function(self)
			if song then
	...
	LoadFont("Common Normal") .. {
		InitCommand = function(self)
			self:xy(skillestxpleasebeconsistentmina, skillsetPrevalentY - distanceSkillsetY * 2):zoom(0.6, maxwidth, 125)
		end,
		MintyFreshCommand = function(self)
	...
	LoadFont("Common Normal") .. {
		InitCommand = function(self)
			self:xy(skillestxpleasebeconsistentmina, skillsetPrevalentY - distanceSkillsetY * 1):zoom(0.6, maxwidth, 125)
		end,
		MintyFreshCommand = function(self)
			if song and GAMESTATE:GetCurrentStyle():ColumnsPerPlayer() == 4 then
	...
	LoadFont("Common Normal") .. {
		InitCommand = function(self)
			self:xy(skillestxpleasebeconsistentmina, skillsetPrevalentY - distanceSkillsetY * 0):zoom(0.6, maxwidth, 125)
		end,
		MintyFreshCommand = function(self)
			if song and GAMESTATE:GetCurrentStyle():ColumnsPerPlayer() == 4 then
	...
	--todo: fix the mirror indicator, low priority i know
	LoadFont("Common Large") .. {
		InitCommand = function(self)
			self:xy(frameX + 13, frameY):zoom(0.4):halign(0):maxwidth(150):valign(1)
		end,
		MintyFreshCommand = function(self)
	...
	LoadFont("Common Normal") .. {
		InitCommand = function(self)
			self:xy(frameX + 95, frameY - 2):zoom(0.4):halign(0)
		end,
		MintyFreshCommand = function(self)
			if song and score then
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		Name = "Goalll",
		InitCommand = function(self)
			self:xy(frameX - 20, frameY):zoom(0.6):halign(1):valign(0)
		end,
	...
	LoadFont("Common Normal") .. {
		InitCommand = function(self)
			self:xy(frameX + 12, frameY + 20):zoom(0.35):halign(0)
		end,
		MintyFreshCommand = function(self)
			if song and score then
	...
	LoadFont("Common Normal") .. {
		InitCommand = function(self)
			self:xy(frameX + 13, frameY + 10):zoom(0.27):halign(0)
		end,
		MintyFreshCommand = function(self)
			if song and score then
	...
	LoadFont("Common Normal") .. {
		Name = "ClearType",
		InitCommand = function(self)
			self:xy(frameX + 107, frameY - 12):zoom(0.4):maxwidth(200)
		end,
		MintyFreshCommand = function(self)
			if song and score then
				self:visible(true)
	...
	Def.BPMDisplay {
		...
		Name = "BPMDisplay",
		InitCommand = function(self)
			self:xy(SCREEN_RIGHT - 52, 55):halign(1):zoom(0.50):maxwidth(50)
		end,
		MintyFreshCommand = function(self)
			if song then
				self:visible(true)
	...
	LoadFont("Common Large") .. {
		...
		InitCommand = function(self)
			self:xy(SCREEN_RIGHT - 30, 75):visible(true):halign(1):zoom(
...
local function radarPairs(i)
	local o = Def.ActorFrame {
		...
		LoadFont("Common Normal") .. {
			InitCommand = function(self)
				self:xy(frameX + 13, frameY - 152 + 20 * i):zoom(0.6):halign(0):maxwidth(120)
			end,
			MintyFreshCommand = function(self)
				if song then
		...
		LoadFont("Common Normal") .. {
			InitCommand = function(self)
				self:xy(frameX + 105, frameY - 152 + 20 * i):zoom(0.6):halign(1):maxwidth(60)
			end,
...
t[#t + 1] =LoadFont("Common Normal") .. {
	InitCommand = function(self)
		self:xy(SCREEN_RIGHT - 30, 55):halign(1):zoom(0.50)
	end,
...
local forceStart = toggleButton(translated_info["UnForceStart"], translated_info["ForceStart"], "/force", 420, 0, -110) .. {
	Name = "ForceStart",
}
...
do
	...
	readyButton = toggleButton(translated_info["Unready"], translated_info["Ready"], "/ready", 310, 0, -110, areWeReadiedUp) .. {
		Name = "Ready",
...
t[#t + 1] = LoadFont("Common Normal") .. {
	InitCommand = function(self)
		self:xy(tagXPos, tagPrevalentY - distanceSkillsetY * 3):zoom(0.6):maxwidth(capWideScale(54, 450) / 0.6)
	end,
	MintyFreshCommand = function(self)
...
t[#t + 1] = LoadFont("Common Normal") .. {
	InitCommand = function(self)
		self:xy(tagXPos, tagPrevalentY - distanceSkillsetY * 2):zoom(0.6):maxwidth(capWideScale(54, 450) / 0.6)
	end,
	MintyFreshCommand = function(self)
...
t[#t + 1] = LoadFont("Common Normal") .. {
	InitCommand = function(self)
		self:xy(tagXPos, tagPrevalentY - distanceSkillsetY * 1):zoom(0.6):maxwidth(capWideScale(54, 450) / 0.6)
	end,
	MintyFreshCommand = function(self)
