...
local function makeGoalDisplay(i)
	...
	local o = Def.ActorFrame {
		...
		UIElements.TextToolTip(1, 1, "Common normal") .. {
			--priority
			InitCommand = function(self)
				self:x(c0x):zoom(tetextzoom):halign(0.5):valign(1)
			end,
			DisplayCommand = function(self)
		...
		UIElements.SpriteButton(1, 1, THEME:GetPathG("", "X.png")) .. {
			-- delete button
			InitCommand = function(self)
				self:xy(c0x,pdh/2.3):zoom(0.3):halign(0):valign(1):diffuse(Color.Red)
			end,
			MouseOverCommand = function(self)
				self:diffusealpha(hoverAlpha)
			end,
		...
		UIElements.TextToolTip(1, 1, "Common normal") .. {
			--rate
			InitCommand = function(self)
				self:xy(c1x, -2):zoom(tetextzoom):halign(0.5):valign(1)
			end,
			DisplayCommand = function(self)
		...
		UIElements.TextToolTip(1, 1, "Common normal") .. {
			--percent
			InitCommand = function(self)
				self:x(c1x):zoom(tetextzoom):halign(0.5):valign(0):maxwidth((50 - capWideScale(10, 10)) / tetextzoom)
			end,
			DisplayCommand = function(self)
		...
		UIElements.TextToolTip(1, 1, "Common normal") .. {
			--song name
			InitCommand = function(self)
				self:xy(c2x, -2):zoom(tetextzoom):maxwidth((c3x - c2x - capWideScale(50, 80)) / tetextzoom):halign(0):valign(1):draworder(1)
			end,
			DisplayCommand = function(self)
				if goalsong then
		...
		LoadFont("Common normal") .. {
			--pb
			InitCommand = function(self)
				self:x(c2x):zoom(tetextzoom):halign(0):valign(0)
			end,
			DisplayCommand = function(self)
		...
		LoadFont("Common normal") .. {
			--assigned
			InitCommand = function(self)
				self:x(c4x):zoom(tetextzoom):halign(1):valign(0):maxwidth(width / 3.5 / tetextzoom)
			end,
			DisplayCommand = function(self)
		...
		LoadFont("Common normal") .. {
			--achieved
			InitCommand = function(self)
				self:x(c4x):zoom(tetextzoom):halign(1):valign(1):maxwidth(width / 3.5 / tetextzoom)
			end,
			DisplayCommand = function(self)
		...
		LoadFont("Common normal") .. {
			--msd diff
			InitCommand = function(self)
				self:x(c5x):zoom(tetextzoom):halign(1):valign(1)
			end,
			DisplayCommand = function(self)
				if goalsteps then
		...
		LoadFont("Common normal") .. {
			--steps diff
			InitCommand = function(self)
				self:x(c5x):zoom(tetextzoom):halign(1):valign(0)
			end,
			DisplayCommand = function(self)
