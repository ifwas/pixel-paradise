...
o[#o + 1] = LoadActor(THEME:GetPathG("", "maskingBGMusic")) ..  {
	OnCommand = function(self)
		self:zoomto(SCREEN_WIDTH, SCREEN_HEIGHT):Center():diffusealpha(1):SetTextureFiltering(false):blend("BlendMode_Add")
	end
}
