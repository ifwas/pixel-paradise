...
t[#t + 1] = Def.ActorFrame {
	...
	LoadFont("Common Normal") .. {
		Name = "CurrentTime",
		InitCommand = function(self)
			self:xy(40, SCREEN_BOTTOM - 17):halign(0):valign(1):zoom(0.6)
		end
	},
	...
	LoadFont("Common Normal") .. {
		Name = "SessionTime",
		InitCommand = function(self)
			self:xy(AvatarX - 3, AvatarY + 20):halign(1):valign(0):zoom(0.45)
		end
	}
}
