...
local offsetX = 30
local offsetY = 20
local fuckX = SCREEN_WIDTH * 0.566
local fuckY = 30
...
local l = Def.ActorFrame {
	...
	InitCommand = function(self)
		self:xy(offsetX - 20, offsetY + headeroffY)
	end,
	LoadFont("Common Large") .. {
		Name = "Grades",
		InitCommand = function(self)
			self:xy(frameX + 90,20):zoom(0.65):halign(1):maxwidth(60 / 0.65):settext("")
		end,
		DisplayCommand = function(self)
	...
	LoadFont("Common Normal") .. {
		Name = "Wife",
		InitCommand = function(self)
			self:xy(frameX + 40, 15):zoom(0.6):halign(1):settext("")
		end,
		DisplayCommand = function(self)
	...
	LoadFont("Common Normal") .. {
		Name = "Score",
		InitCommand = function(self)
			self:xy(frameX + 40, 30):zoom(0.6):halign(1):settext("")
		end,
		DisplayCommand = function(self)
			if score:GetWifeScore() == 0 then
				self:settext("")
	...
	LoadFont("Common Normal") .. {
		Name = "Score",
		InitCommand = function(self)
			self:xy(frameX + 40, 43):zoom(0.5):halign(1):settext("")
		end,
		DisplayCommand = function(self)
			if score:GetWifeScore() == 0 then
				self:settext("")
	...
	LoadFont("Common Normal") .. {
		Name = "ClearType",
		InitCommand = function(self)
			self:xy(frameX + 90, 40):zoom(0.5):halign(1):settext(""):diffuse(color(colorConfig:get_data().clearType["NoPlay"]))
		end,
		DisplayCommand = function(self)
	...
	LoadFont("Common Normal") .. {
		Name = "Mods",
		InitCommand = function(self)
			self:xy(frameX + 100, 63):zoom(0.4):halign(1):maxwidth(capWideScale(690,1000))
	...
	LoadFont("Common Normal") .. {
		Name = "Date",
		InitCommand = function(self)
			self:xy(frameX + 100,78):zoom(0.4):halign(1):settextf("%s:", translated_info["DateAchieved"]):settext("")
		end,
		DisplayCommand = function(self)
	...
	LoadFont("Common Normal") .. {
		Name = "Combo",
		InitCommand = function(self)
			self:xy(frameX + 100,93):zoom(0.4):halign(1):settextf("%s:", translated_info["MaxCombo"]):settext("")
		end,
		DisplayCommand = function(self)
	...
	LoadFont("Common Normal") .. {
		Name = "ComboBreaks",
		InitCommand = function(self)
			self:xy(frameX + 100,108):zoom(0.4):halign(1):settextf("%s:", translated_info["ComboBreaks"]):settext("")
		end,
		DisplayCommand = function(self)
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		InitCommand = function(self)
			self:y(frameHeight - headeroffY - 15 - offsetY):zoom(0.5):halign(0)
	...
	LoadFont("Common Normal") .. {
		Name = "Judge",
		InitCommand = function(self)
			self:xy(frameX + offsetX + 70,frameHeight - headeroffY - 65 - offsetY):zoom(0.45):halign(1):settext("")
		end,
		DisplayCommand = function(self)
	...
	LoadFont("Common Normal") .. {
		Name = "ChordCohesion",
		InitCommand = function(self)
			self:xy(frameX + offsetX + 70,frameHeight - headeroffY - 50 - offsetY):zoom(0.4):halign(1):settext("")
		end,
		DisplayCommand = function(self)
...
local function makeText(index)
	return UIElements.TextToolTip(1, 1, "Common Normal") .. {
		InitCommand = function(self)
			self:xy(frameWidth, offsetY + 120 + (index * 15)):zoom(fontScale + 0.05):halign(1):settext("")
		end,
		DisplayCommand = function(self)
			local count = 0
...
l[#l + 1] = UIElements.TextToolTip(1, 1, "Common Normal") .. {
	Name = "Score",
	InitCommand = function(self)
		self:xy(frameWidth - 15,frameHeight - headeroffY - 15 - offsetY):zoom(0.55):halign(1):settext("")
		self:diffuse(getMainColor("positive"))
	end,
	DisplayCommand = function(self)
...
l[#l + 1] = UIElements.TextToolTip(1, 1, "Common Normal") .. {
	Name = "ReplayViewer",
	InitCommand = function(self)
		self:xy(frameWidth - 15,frameHeight - headeroffY - 30 - offsetY):zoom(0.55):halign(1):settext("")
		self:diffuse(getMainColor("positive"))
	end,
	BeginCommand = function(self)
...
l[#l + 1] = Def.ActorFrame {
	...
	UIElements.QuadButton(1, 1) .. {
		Name = "EvalViewQuad",
		InitCommand = function(self)
			self:xy((frameWidth - offsetX) / 2.1, frameHeight - headeroffY - 17 - offsetY):diffuse(0,0,0,0)
...
l[#l + 1] = UIElements.TextToolTip(1, 1, "Common Normal") .. {
	Name = "TheDootButton",
	InitCommand = function(self)
		self:y(frameHeight - headeroffY - 35 - offsetY):zoom(0.525):halign(0):settext("")
		self:diffuse(getMainColor("positive"))
	end,
	DisplayCommand = function(self)
...
l[#l + 1] = UIElements.TextToolTip(1, 1, "Common Normal") .. {
	...
	InitCommand = function(self)
		self:y(frameHeight - headeroffY - 49 - offsetY):zoom(0.425):halign(0):settext("")
		self:diffuse(getMainColor("positive"))
	end,
	DisplayCommand = function(self)
...
l[#l + 1] = UIElements.TextToolTip(1, 1, "Common Normal") .. {
	...
	InitCommand = function(self)
		self:y(frameHeight - headeroffY - 63 - offsetY):zoom(0.425):halign(0):settext("")
		self:diffuse(getMainColor("positive"))
	end,
	DisplayCommand = function(self)
...
l[#l + 1] = UIElements.TextToolTip(1, 1, "Common Normal") .. {
	...
	InitCommand = function(self)
		self:y(frameHeight - headeroffY - 76 - offsetY):zoom(0.425):halign(0):settext("")
		self:diffuse(getMainColor("positive"))
	end,
	DisplayCommand = function(self)
...
t[#t + 1] = Def.Quad {
	...
	DisplayCommand = function(self)
		self:finishtweening()
		self:smooth(0.15)
		self:zoomy(((frameHeight - fuckY) / #rtTable[rates[rateIndex]]))
		self:y((((frameHeight - fuckY) / #rtTable[rates[rateIndex]]) * scoreIndex) + fuckY)
	end
}
...
local function nestedTabButton(i)
	return Def.ActorFrame {
		Name = "Button_"..i,
		InitCommand = function(self)
			self:xy(frameX + 20 + offsetX/2 + (i - 1) * (nestedTabButtonWidth - capWideScale(100, 80)), frameY + offsetY - 4)
		end,
		CollapseCommand = function(self)
			self:visible(false)
		end,
