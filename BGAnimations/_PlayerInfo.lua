...
t[#t + 1] = Def.ActorFrame {
	...
	UIElements.SpriteButton(1, 1, nil) .. {
		...
		ModifyAvatarCommand = function(self)
			...
			self:zoomto(AvatarSize * avatarexponent, AvatarSize * avatarexponent)
		end,
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		...
		InitCommand = function(self)
			self:halign(0)
			self:xy(AvatarX + AvatarSize, AvatarY + 12)
			self:zoom(0.57)
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		InitCommand = function(self)
			self:xy(SCREEN_WIDTH - 150, AvatarY + 30):halign(0.5):zoom(0.4):diffuse(ButtonColor)
		end,
		BeginCommand = function(self)
			self:queuecommand("Set")
		end,
		...
		SetCommand = function(self)
			...
			self:y(AvatarY + 30 - (online and 18 or 0))
...
t[#t + 1] = Def.ActorFrame {
	...
	LoadFont("Common Normal") .. {
		Name = "CurrentTime",
		InitCommand = function(self)
			self:xy(SCREEN_WIDTH - 3, AvatarY + 35):halign(1):valign(1):zoom(0.7)
		end
	},
	...
	LoadFont("Common Normal") .. {
		Name = "SessionTime",
		InitCommand = function(self)
			self:xy(AvatarX + AvatarSize, AvatarY + 30):halign(0):valign(1):zoom(0.45)
