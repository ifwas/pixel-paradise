...
local f = Def.ActorFrame {
    ...
    Def.Sprite {
	    InitCommand = function(self)
		    self:y(30):zoom(0.46):halign(0):valign(0)
		    self:Load(THEME:GetPathG("","spr/tab/boxFilter")):SetTextureFiltering(false)
		    self:diffuse(getMainColor("positive"))
	    end
    },
	Def.Sprite {
		InitCommand = function(self)
			self:zoom(0.46):halign(0):valign(0)
			self:Load(THEME:GetPathG("","spr/tab/boxHeaderFilter")):SetTextureFiltering(false)
		    self:diffuse(getMainColor("positive"))
		end
	},
	LoadFont("Common Normal") .. {
		InitCommand = function(self)
			self:xy(10, offsetY - 9):zoom(0.6):halign(0):settext(translated_info["Title"])
	...
	LoadFont("Common Large") .. {
		InitCommand = function(self)
			self:xy(frameX -265, frameY + 80 -17):zoom(0.3):halign(0)
...
local function CreateFilterInputBox(i)
	local t = Def.ActorFrame {
		...
		UIElements.SpriteButton(1, 1, nil) .. {
			InitCommand = function(self)
				self:addx(i == (#ms.SkillSets + 1) and 166 or (i == (#ms.SkillSets + 2) and 162 or 160)):addy(175 + (i - 1) * spacingY):zoomto(
					i == (#ms.SkillSets + 1) and 0.40 or (i == (#ms.SkillSets + 2) and 0.43 or 0.40),
					0.40
				):halign(1)
				self:Load(THEME:GetPathG("","spr/tab/boxNumberFilter")):SetTextureFiltering(false)
			end,
			MouseDownCommand = function(self, params)
				if params.event == "DeviceButton_left mouse button" and active then
					ActiveSS = i
		...
		UIElements.SpriteButton(1, 1, nil) .. {
			InitCommand = function(self)
				self:addx(i == (#ms.SkillSets + 1) and 198 or (i == (#ms.SkillSets + 2) and 193 or 190)):addy(175 + (i - 1) * spacingY):zoomto(
					i == (#ms.SkillSets + 1) and 0.40 or (i == (#ms.SkillSets + 2) and 0.43 or 0.40),
					0.40
				):halign(1)
				self:Load(THEME:GetPathG("","spr/tab/boxNumberFilter")):SetTextureFiltering(false)
		...
		LoadFont("Common Large") .. {
			InitCommand = function(self)
				self:addx(i == (#ms.SkillSets + 1) and 193 or (i == (#ms.SkillSets + 2) and 193 or 180)):addy(175 + (i - 1) * spacingY):halign(1):maxwidth(60):zoom(
					textzoom
				)
			end,
			SetCommand = function(self)
...
f[#f + 1] = UIElements.TextButton(1, 1, "Common Large") .. {
	InitCommand = function(self)
		self:xy(frameX + frameWidth - capWideScale(350,430), frameY + 250 + spacingY * 2)
